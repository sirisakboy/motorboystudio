...
export const AppShell: React.FC<AppShellProps> = ({ children, onSimulate }) => {
  return (
    <div className="app-container">
      ...
      <div className="toolbar">
        <button onClick={onSimulate} className="flex items-center gap-1"><FolderOpen size={16} /> Open</button>
